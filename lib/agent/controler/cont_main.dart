...
class ContMainScreen extends StatefulWidget {
  const ContMainScreen({super.key});

  @override
  State<ContMainScreen> createState() => _ContMainScreenState();
}

class _ContMainScreenState extends State<ContMainScreen>
    ...
    return FadeTransition(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(
            "Scannez le QR code d’un bovin pour afficher sa fiche complète, vérifier sa conformité sanitaire ou ajouter un nouveau bovin.",
            textAlign: TextAlign.center,
            style: GoogleFonts.nunito(
              fontSize: 18,
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Flexible(
                    child: Text(
                      "Le QR code contient toutes les informations officielles du bovin ou permet d’ajouter un nouveau bovin validé par MINEPIA.",
                      style: GoogleFonts.nunito(
                        fontSize: 15,
                        color: Colors.blueGrey.shade700,
                      ),
                    ...
                    SnackBar(
                      content: Row(
                        children: [
                          ...
                          const Flexible(
                              child: Text(
                                  "Alerte sanitaire a été envoyée au MINEPIA...",
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis)),
                        ],
                      ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text(
                    "Ce code QR est validé par MINEPIA pour le propriétaire suivant. Vous pouvez ajouter les informations de ce bovin.",
                    textAlign: TextAlign.center,
                    style: GoogleFonts.nunito(
                      fontSize: 17,
                      color: Colors.blueGrey.shade700,
            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                        ...
                        SnackBar(
                          content: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              const Flexible(
                                  child: Text("Déclaration d'évènement...",
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis)),
                            ],
                          ),
                  ...
                  _actionButton(
                    icon: Icons.medical_services,
                    label: "Historique sanitaire",
                    color: Colors.blue.shade700,
                    onTap: () {
                      context.go('/health', extra: {
                        //'code': bovinData?['code'],
                        'code': data['code'],
                      });
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              const Flexible(
                                  child: Text("Consultation de l'historique...",
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis)),
                            ],
                          ),
