...
class ContHealthScreen extends StatefulWidget {
  ...
  final String? code;
  const ContHealthScreen({super.key, this.code});

  @override
  State<ContHealthScreen> createState() => _ContHealthScreenState();
  static ContHealthScreen fromGoRouter(BuildContext context) {
    final state = GoRouterState.of(context);
    final extra = state.extra as Map<String, dynamic>? ?? {};
    return ContHealthScreen(
